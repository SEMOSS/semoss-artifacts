...
sed "/<web-app.*/,/<\/web-app>/ {/<filter>/,/<\/filter>/ {/<init-param>/,/<\/init-param/ {/<param-name>trustedTokenDomain<\/param-name>/,/<param-value>/ s/*/$TRUSTED_TOKEN_DOMAIN/}}}" $SCRIPT_TOMCAT_HOME/webapps/Monolith/WEB-INF/web.xml
