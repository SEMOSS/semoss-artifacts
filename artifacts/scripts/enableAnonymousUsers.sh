...
sed -i '/<web-app.*/,/<\/web-app>/ {/<context-param>/,/<\/context-param>/ {/<param-name>anonymous-users-allowed<\/param-name>/,/<param-value>/ s/false/true/}}' $SCRIPT_TOMCAT_HOME/webapps/Monolith/WEB-INF/web.xml
