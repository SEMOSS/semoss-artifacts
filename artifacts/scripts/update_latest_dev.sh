...
if ! [[ -z "${SEMOSS_VERSION}" ]] || [[ (( $last_updated > $updated )) ]]; then
        ...
        mv /opt/semoss-artifacts/artifacts/home/semoss*/* /opt/semosshome
	...
	rm -r /opt/semoss-artifacts/artifacts/home/target
        ...
        mv /opt/semoss-artifacts/artifacts/web/semoss*/* $SCRIPT_TOMCAT_HOME/webapps/SemossWeb
	...
	rm -r /opt/semoss-artifacts/artifacts/web/target
        ...
        mv /opt/semoss-artifacts/artifacts/war/monolith*/* $SCRIPT_TOMCAT_HOME/webapps/Monolith
	...
	rm -r /opt/semoss-artifacts/artifacts/war/target
        ...
        mv /opt/semoss-artifacts/artifacts/lib/monolith*/* $SCRIPT_TOMCAT_HOME/webapps/Monolith
